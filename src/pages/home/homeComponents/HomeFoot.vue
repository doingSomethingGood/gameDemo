<template>
  <div class="container">
    <div class="foot-button" @click="footButtonClick" :class="{'clicked':isClicked[0]}">
      <span class="iconfont foot-icon" :class="{'change-color':isClicked[0]}" :data-index="1">&#xe60b;</span>
    ...
    <div class="foot-button" @click="footButtonClick" :class="{'clicked':isClicked[1]}">
      <span class="iconfont foot-icon" :class="{'change-color':isClicked[1]}">&#xe659;</span>
    ...
    <div class="foot-button" @click="footButtonClick" :class="{'clicked':isClicked[2]}">
      <span class="iconfont foot-icon" :class="{'change-color':isClicked[2]}">&#xe615;</span>
    ...
    <div class="foot-button" @click="footButtonClick" :class="{'clicked':isClicked[3]}">
      <span class="iconfont foot-icon" :class="{'change-color':isClicked[3]}">&#xe606;</span>
